...
//
// @class CRWCLShineButtonDemoVC
// @abstract WCLShineButton的DemoVC
// @discussion WCLShineButton的DemoVC
//

import UIKit
import WCLShineButton

class CRWCLShineButtonDemoVC: CRProductionBaseVC {

    //MARK: Override
    override func viewDidLoad() {
        super.viewDidLoad()
        createUI()
        addTopBar(withTitle: "WCLShineButton")
    }
    ...
    override func createUI() {
        ...
        bt1.center = .init(x: center.x - 50, y: center.y - 50)
        view.addSubview(bt1)
        ...
        bt2.center = .init(x: center.x + 50, y: center.y - 50)
        view.addSubview(bt2)
        ...
        bt3.center = .init(x: center.x - 50, y: center.y + 50)
        view.addSubview(bt3)
